...
namespace SteamSearchApi.Models.Repositories
{
    public class MongoRepository<T> where T : IMongoObject
    {
        ...
        public MongoRepository(string connectionString)
        {
            ...
            dbName = (Util.GetAttribute<T>(typeof(MongoDBDatabaseName)) as MongoDBDatabaseName).Name;
            collectionName = (Util.GetAttribute<T>(typeof(MongoDBCollectionName)) as MongoDBCollectionName).Name;
        ...
        public List<U> GetAll<U>()
        {
            ...
            return collection.AsQueryable<U>().ToList();
        }
        ...
        public bool Exists(Func<T, bool> selector)
        {
            ...
            var result =
    (from c in _collection.AsQueryable<T>()
     select c)
    .Any(selector);
        ...
        public bool Exists<U>(Func<U, bool> selector)
        {
            ...
            var result =
    (from c in collection.AsQueryable<U>()
     select c)
    .Any(selector);
